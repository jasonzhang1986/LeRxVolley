...
//        }
    ...
    public static void get(Context context,String url, HttpCallback callback) {
        new Builder().url(url).callback(callback).doTask(context);
    }

    public static void get(Context context,String url, HttpParams params, HttpCallback callback) {
        new Builder().url(url).params(params).callback(callback).doTask(context);
    }

    public static void post(Context context,String url, HttpParams params, HttpCallback callback) {
        new Builder().url(url).params(params).httpMethod(Method.POST).callback(callback).doTask(context);
    }

    public static void post(Context context,String url, HttpParams params, ProgressListener listener,
                            HttpCallback callback) {
        new Builder().url(url).params(params).progressListener(listener).httpMethod(Method.POST)
                .callback(callback).doTask(context);
    }

    public static void jsonGet(Context context,String url, HttpParams params, HttpCallback callback) {
        new Builder().url(url).params(params).contentType(ContentType.JSON)
                .httpMethod(Method.GET).callback(callback).doTask(context);
    }

    public static void jsonPost(Context context,String url, HttpParams params, HttpCallback callback) {
        new Builder().url(url).params(params).contentType(ContentType.JSON)
                .httpMethod(Method.POST).callback(callback).doTask(context);
    }
     ...
     * @return 缓存内容
     */
    public static byte[] getCache(Context context,String url) {
        ICache cache = getRequestQueue(context).getCache();
        if (cache != null) {
    ...
    public static void download(Context context,String storeFilePath, String url, ProgressListener
        ...
        request.setTag(url);
        request.setOnProgressListener(progressListener);
        new Builder().setRequest(request).doTask(context);
    }
}
